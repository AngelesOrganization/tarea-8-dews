...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Introducir articulos</title>
        <link rel="stylesheet" href="{{asset('css/style.css')}}">
        <!-- Fonts -->
        <link href="https://fonts.bunny.net/css2?family=Nunito:wght@400;600;700&display=swap" rel="stylesheet">
        <script src="https://kit.fontawesome.com/2c734b141e.js" crossorigin="anonymous"></script>
        <!-- Styles -->
        <style>
        ...
        <script>
            function mostrar_sugerencias(str) {
                ...
                if (str.length == 0) { 
                    ...
                    asyncRequest.open("GET", "{{ url('/libros') }}?query="+str, true);
                    ...
                    function stateChange(){
                        ...
                        if (asyncRequest.readyState == 4 && asyncRequest.status == 200) {
                            ...
                            // id "sugerencias"
                            let librosTexto = asyncRequest.responseText;

                            if(librosTexto == "Error: el parametro query debe contener solo letras.") {
                                document.getElementById("sugerencias").innerHTML = "Error: el parametro query debe contener solo letras.";
                            } else {
                                let libros = JSON.parse(asyncRequest.responseText);
                                console.log(libros);
                                let htmlList = "<ul>";

                                libros.forEach(function(libro){
                                    htmlList += `<li>${libro.titulo}</li>`;
                                });
                                htmlList += "</ul>";

                                document.getElementById("sugerencias").innerHTML = htmlList;
    ...
    <body class="antialiased">
        ...
        <p><strong>Libros:</strong> <span id="sugerencias" style="color: #0080FF;"></span></p>
    </body>
</html>